...
;globalThis.__GAME__ = {
  ...
  fns: {
    ...
    getStrikeShip, strikeBossType, strikeBossFire,
    isStrikeUnlocked, strikeTicketState, syncStrikeTickets, getStrikeLoadout, strikeEnemyHp, strikeBulletDamage, strikeWaveAt, strikeReward,
