...
;globalThis.__GAME__ = {
  ...
  consts: { FRENZY_MAX, FRENZY_DURATION, TRANSCEND_BASE, DAILY_CHALLENGE_TARGET, SET_DEFS, ACHIEVEMENTS, LEVEL_NAMES, TRANSCEND_NAMES_61_80, EXPEDITION_TIERS, EXPEDITION_UNLOCK_LV, TOWER_FLOORS, TOWER_UNLOCK_PRESTIGE, TOWER_DEEP_PATTERNS, TOWER_MAX_FLOOR, ENGRAVE_RUNES, ENGRAVE_COSTS, ENGRAVE_MAX, ENGRAVE_SWAP_COST, ENGRAVE_UNLOCK_PRESTIGE, CHARM_POLICIES, CHARM_CAP, CHARM_FRONTIER_GAP, CONSTELLATION_STARS, CONSTELLATION_ALLOC_IDS, GRAINS, GRAIN_PURE_MUL, GRAIN_OFF_MUL, GRAIN_UNLOCK_LV, FORGE_MODES, FORGE_UNLOCK_LV, UPGRADES, SKILLS, TIER_GATES },
};
`;
